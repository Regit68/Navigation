...
struct PublicationStorage {
    ...
    /// Section 0.
    static let photoGalary = [
        PhotoGalleryModel(
            photos:[rollsRoyce!, snowboarder!, tulipsField!, catDog!, cake!, flamingo!, girl!, mallard!, iceCream!, japaneseGarden!, horseLady!, madHatter!, northernLight!, pathosFair!, spermWhale!, samoyeds!, scientistsSingapore!, surfing!, universe!, wingsuitRider!]
        )
